"""
脚質特徴量を追加したLightGBMモデル訓練（最適化版）
- DataFrameを直接使用してPassageデータから脚質を分類
- CSVの繰り返し読み込みを回避
"""
import pandas as pd
import sys
...
print("=" * 80)
print("脚質特徴量を追加したLightGBMモデル訓練（最適化版）")
print("=" * 80)
...
feature_names = [
    ...
    # 脚質特徴量（NEW!）
    'escape_rate', 'leading_rate', 'closing_rate', 'pursuing_rate', 'avg_agari', 'has_past_results'
]
...
print(f"特徴量数: {len(feature_names)}次元 (従来22次元 + 脚質6次元)")

# モデル訓練
print("\n" + "=" * 80)
print("脚質特徴量込みでモデル訓練中...")
print("=" * 80)
...
# モデルを保存
model_path = r"C:\Users\bu158\Keiba_Shisaku20250928\lightgbm_model_with_running_style.pkl"
