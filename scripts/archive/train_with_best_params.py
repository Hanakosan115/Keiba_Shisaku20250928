"""
ベストパラメータでLightGBMモデルを訓練
- チューニング結果: num_leaves=63, learning_rate=0.05
- 2020-2022年データで訓練
"""
import pandas as pd
import json
...
print("=" * 80)
print("チューニング済みパラメータでLightGBM訓練")
print("=" * 80)

# データ読み込み（メインデータ: 2025年8月まで）
print("\nデータ読み込み中...")
...
# ベストパラメータで訓練
print("\n" + "=" * 80)
print("ベストパラメータ (num_leaves=63) でモデル訓練中...")
print("=" * 80)
