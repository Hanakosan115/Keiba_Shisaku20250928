"""
脚質特徴量込みモデルでバックテスト
- lightgbm_model_with_running_style.pkl を使用
- 2位・3位の予測精度が改善されているか検証
- 3連系の的中率を分析
"""
import pandas as pd
import json
...
payout_dict = load_payout_data(r"C:\Users\bu158\HorseRacingAnalyzer\data\一旦避難用\netkeiba_data_payouts_202001_202508.json")
